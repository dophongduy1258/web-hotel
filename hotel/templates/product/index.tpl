...
<div class="content-product z2">
    <div class="container">
        <div class="block-title">
            <h2 class="title"><a href="" style="pointer-events: none;" title="#">{if isset($data.category.name) && $data.category.name !=''}{$data.category.name}{else}Danh sách sản phẩm{/if}</a></h2>

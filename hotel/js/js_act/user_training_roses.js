...
var recent_page = 1;
var department_from = $("#coaching_from");
var department_keyword = $("#coaching_keyword");
var department_btn_view = $("#coaching_btn_view");
var page_html = $("#coaching_page_html");
var department_list = $("#coaching_list");
var type_page = 'comm_coach';
...
thePage.filter = () => {
    ...
    _doAjaxNod('POST', data, 'user_training_roses', 'idx', type_page, true, (res) => {
        // console.log(res.data);
        $("#coaching_total_record").html(number_format_replace_cog(res.data.info.total_record));
        $("#coaching_total_order_real").html(number_format_replace_cog(res.data.info.total_order_real));
        $("#coaching_total_order").html(number_format_replace_cog(res.data.info.total_order));
        $("#coaching_total_commission").html(number_format_replace_cog(res.data.info.total_commission));

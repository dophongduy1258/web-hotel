...
var page_html = $("#departMRe_page_html");
var department_list = $("#departMRe_list");
var type_page = 'reve_department';
...
thePage.filter = () => {
    ...
    _doAjaxNod('POST', data, 'user_departmental_revenue', 'idx', type_page, true, (res) => {
        // console.log(res.data);
        $("#departMRe_total_record").html(number_format_replace_cog(res.data.info.total_record));
        $("#departMRe_total_order_real").html(number_format_replace_cog(res.data.info.total_order_real));
        $("#departMRe_total_order").html(number_format_replace_cog(res.data.info.total_order));

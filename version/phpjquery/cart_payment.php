...
function register_member($fullname, $email, $mobile, $password, $referral_by)
{
    ...
    if ($mobile == '') {
        ...
        if ($referral_by != '' && !isset($dParent['user_id']) && !isset($dParentByID['user_id'])) {
            ...
            $members->set('member_department_id', $setup['default_member_department_id'] != '' ? $setup['default_member_department_id'] : 0);
            $members->set('cum', '');
            $members->set('kvkd', '');
            $members->set('gdkd', '');
            ...
            $members->set('member_group_id', $setup['member_group_trial'] != '' ? $setup['member_group_trial'] : 0);
            ...
            $members->set('note', '');
            $members->set('by_user_cs', $setup['default_by_user_cs'] != '' ? $setup['default_by_user_cs'] : 0);

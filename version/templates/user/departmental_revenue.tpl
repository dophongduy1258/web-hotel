							...
							<table class="table table-key">
								<thead>
									<tr>
										...
										<th class="col_vi col-de-full"><div class="short_up"><span>Ngày tạo</span><a field="order_created_at" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
										<th class="col_vi col-de-full"><div class="short_up"><span>Họ &amp; Tên</span><a field="fullname" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
										<th class="col_vi col-de-full">SĐT</th>
										<th class="col_vi col-de-full"><div class="short_up"><span>Mã KH</span><a field="code" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
										<th class="col_vi "><div class="short_up"><span>Phòng ban</span><a field="member_department_name" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
										<th class="col_vi "><div class="short_up"><span>Mã phòng ban</span><a field="member_department_id" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
										<th class="col_vi col-de-full">Mã đơn hàng</th>
										<th class="col_vi "><div class="short_up"><span>DS giá lẻ</span><a field="total_order_real" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
										<th class="col_vi "><div class="short_up"><span>DS thực thu</span><a field="total_order" class="fa fa-caret-up sortByDepartMRe sortBy"></a></div></th>
									</tr>
								</thead>
								...
								<thead>
									<tr>
										...
										<th class="col_vi "><a id="departMRe_total_record">0</a></th>
										<th class="col_vi col-de-full"></th>
										<th class="col_vi col-de-full"></th>
										<th class="col_vi">Tổng: </th>
										<th class="col_vi"><a id="departMRe_total_order_real">0</a></th>
										<th class="col_vi"><a id="departMRe_total_order">0</a></th>
									</tr>
								</thead>
